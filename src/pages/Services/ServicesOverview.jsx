        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {pillars.map((pillar, idx) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 bg-green-900 group-hover:bg-amber-100 rounded-xl flex items-center justify-center mb-5 transition-colors">
                  <Icon className="w-7 h-7 text-green-100 group-hover:text-amber-600 transition-colors" />
                </div>
