        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <div id="ourstory" className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-base md:text-md leading-8 text-gray-600">
              OB39 was founded to support entrepreneurs and famers, youth and women as well as solve a critical challenge: the high
          ...
          <div className="relative overflow-hidden rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-200/60 sm:p-10 lg:p-12">
            ...
            <p className="relative mt-7 text-baase  sm:text-md leading-relaxed text-gray-600">
              ...
              integrated ecosystem. We are combining cooperative finance, business
